...
- **Minecraft Versions**: **1.21 - 26.2** (1.21, 1.21.x, 26.1, 26.2+).
- **Server Software**: Paper, Purpur, Spigot, Bukkit, and Folia (Java 21 required).
- **Proxy Compatibility**: Fully compatible on sub-servers behind Velocity, BungeeCord, and Waterfall proxies.
